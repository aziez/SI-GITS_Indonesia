...
public class MainActivity extends AppCompatActivity {
    ...
    private  int getRandomColor(String typeColor){
        ...
        if (arrayId != 0){
            TypedArray color = getResources().obtainTypedArray(arrayId);
            int index = (int) (Math.random() * color.length());
            returnColor = color.getColor(index, Color.GRAY);
            color.recycle();
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    "mobile","id"}, new int[]{R.id.nama,
                    R.id.email, R.id.nomor,R.id.textbg});
